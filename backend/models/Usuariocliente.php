...
class Usuariocliente extends Model
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'vchNombres' => 'Nombres',
            'vchApellidoPaterno' => 'Apellido Paterno',
            'vchApellidoMaterno' => 'Apellido Materno',
            'intCodigoSexo' => 'Genero',
            'dtmFechaNacimiento' => 'Fecha de Nacimiento',
            'intIdUbigeo' => 'Ubicación',
            'vchDomicilioUbigeo' => 'Domicilio Ubigeo',
            'vchDomicilioDireccion' => 'Direccion',
            'vchDomicilioReferencia' => 'Referencia',
            'vchCelular' => 'Celular',
