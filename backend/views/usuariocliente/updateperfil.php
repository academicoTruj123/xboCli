            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                <?= $form->field($model, 'vchNombres', $fieldOptions1)
                        ->label(true)
                        ->textInput(['placeholder' => 'Ingresar '.$model->getAttributeLabel('vchNombres'),'maxlength' => true]) ?>

                <?= $form->field($model, 'vchApellidoPaterno', $fieldOptions1)
                        ->label(true)
                        ->textInput(['placeholder' => 'Ingresar '.$model->getAttributeLabel('vchApellidoPaterno'),'maxlength' => true]) ?>

                <?= $form->field($model, 'vchApellidoMaterno', $fieldOptions1)
                        ->label(true)
                        ->textInput(['placeholder' => 'Ingresar '.$model->getAttributeLabel('vchApellidoMaterno'),'maxlength' => true]) ?>

                
              <div class="form-group">              
                  <label class="label-input-text"><?= $model->getAttributeLabel('dtmFechaNacimiento') ?></label>
                <div class="input-group date">
                 ...
                 <?= $form->field($model, 'dtmFechaNacimiento',$fieldOptionsdpck)
                        ->label(false)
                        ->textInput(['placeholder' => 'Ingresar '.$model->getAttributeLabel('dtmFechaNacimiento'),'class' => 'form-control pull-right','id'=>'datepicker']) ?>                  
                </div>                
              </div>
                ...
                <div class="form-group">
                    <div class="clearfix" id="UserLogin-gender">                                               
                        <label class="label-input-text"><?= $model->getAttributeLabel('intCodigoSexo') ?></label>                        
                        <?=
              ...
              ?>
                ...
                <?= $form->field($model, 'vchDomicilioReferencia', $fieldOptions1)
                        ->label(true)
                        ->textInput(['placeholder' => 'Ingresar '.$model->getAttributeLabel('vchDomicilioReferencia'),'maxlength' => true]) ?>
